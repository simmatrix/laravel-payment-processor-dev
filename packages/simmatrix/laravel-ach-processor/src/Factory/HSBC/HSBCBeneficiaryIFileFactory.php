...
class HSBCBeneficiaryIFileFactory
{
    ...
    public static function createBeneficiaryRecordLine( BeneficiaryAdapterInterface $beneficiary, $config_key, $payment_description ) 
    {
        ...
        $columns = [
            ...
            'second_party_identifier'           => VariableLengthStringColumnFactory::create( $beneficiary -> getPayeeIdentificationNumber(), $max_length = 12, $label = 'second_party_identifier'),
            ...
            'second_party_reference'            => VariableLengthStringColumnFactory::create( $payment_description, $max_length = 12, $label = 'second_party_reference'),
